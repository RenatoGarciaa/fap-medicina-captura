...
const HeroSection = () => {
  ...
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
          ...
          <div className="text-left text-white space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <img src="/lovable-uploads/8d2d87c2-7baf-445d-92a1-42848628fdac.png" alt="MEDICINA" className="h-16 md:h-20 lg:h-24 w-auto" />
              </div>
            ...
            <div className="flex items-center space-x-4 bg-white/10 backdrop-blur rounded-2xl p-4 w-fit">
              <img src="/lovable-uploads/8cc26806-08d4-406d-9501-f6e602d71d69.png" alt="5" className="h-12 w-auto" />
              <div>
                <p className="text-lg font-bold">NOTA MÁXIMA</p>
                <p className="text-sm opacity-90">NO MEC!</p>
              </div>
              <img src="/lovable-uploads/07d1a877-d5b7-4ef3-b184-ae488822dadd.png" alt="5 estrelas" className="h-6 w-auto" />
            </div>
            ...
            {/* CTA Button */}
            <div className="pt-4">
              <Button variant="gradient" size="lg" className="text-lg px-8 py-4 font-semibold" onClick={handleCTAClick}>
                Garanta sua vaga agora
              </Button>
            </div>
            
            {/* Info adicional */}
            <div className="text-sm text-gray-200 bg-black/20 rounded-lg p-3 w-fit">🌐medicina2.fapce.edu.br</div>
          </div>
          
          {/* Right side - Estudante oficial */}
          <div className="hidden lg:flex justify-center items-center">
            <div className="relative">
              <img src="/lovable-uploads/a80bc1e5-08f7-4b3c-8c6d-f7f23469f8ca.png" alt="Estudante de Medicina FAP" className="max-w-full h-auto drop-shadow-2xl" />
      ...
      <div className="lg:hidden absolute bottom-4 right-4 opacity-30">
        <img src="/lovable-uploads/a80bc1e5-08f7-4b3c-8c6d-f7f23469f8ca.png" alt="Estudante de Medicina FAP" className="h-32 w-auto" />
      </div>
    </section>;
};
